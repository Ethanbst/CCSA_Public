...
class RapportActivite(models.Model):
    ...
    year = models.IntegerField(verbose_name="Année du rapport",
                               unique=True)
    description = models.TextField(verbose_name="Description du rapport", blank=True,
                                   null=True)
    publish_date = models.DateTimeField(
        verbose_name="Date de publication du rapport",
        auto_now_add=True
    )
    file = models.FileField(
        verbose_name="Fichier du rapport",
        upload_to='rapports_activite/rapports/', validators=[
