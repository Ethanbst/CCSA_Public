...
def add_service(request):
    ...
    return render(request, 'services/ajout-service.html',
...
def update_service(request, id):
    ...
    return render(request, 'services/modifier-service.html',
                  {'service_form': service_form})
...
def delete_service(request, id):
    ...
    if request.method == 'POST':
        service.delete()
        return redirect('services:admin_services_list')
    return render(request, 'services/supprimer-service.html',
                  {'service': service})
