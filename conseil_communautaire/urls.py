...
urlpatterns = [
    ...
    path('adminccsa/supprimer-ville/<int:city_id>/', views.delete_city,
         name='admin_delete_city'),
    path('adminccsa/modifier-ville/<int:city_id>/', views.edit_city,
         name='admin_edit_city'),

    # URL Membres
    path('adminccsa/ajouter-membre/', views.add_member, name='admin_member_add'),
    path('adminccsa/liste-membres/', views.admin_list_members,
         name='admin_membres_list'),
    path('adminccsa/modifier-membre/<int:id>/', views.edit_member,
