...
from .models import ConseilVille, ConseilMembre
from .forms import ConseilVilleForm, ConseilMembreForm
...
def add_city(request):
    ...
    return render(request, 'conseil_communautaire/admin_city_add.html',
                  {'city_form': city_form})
...
def list_cities(request):
    ...
    return render(request, 'conseil_communautaire/admin_cities_list.html',
                  context)
...
def delete_city(request, city_id):
    ...
    if request.method == 'POST':
        ...
        city.delete()
        return redirect('conseil_communautaire:admin_list_cities')
    return render(request, 'conseil_communautaire/admin_city_delete.html',
                  {'city': city})
...
def edit_city(request, city_id):
    ...
    return render(request, 'conseil_communautaire/admin_city_edit.html',
                  {'city': city_form})
...
def add_member(request):
    ...
    return render(request, 'conseil_communautaire/admin_member_add.html',
...
def edit_member(request, id):
    ...
    return render(request, 'conseil_communautaire/admin_member_edit.html',
                  {'member': member_form})
...
def delete_member(request, id):
    ...
    if request.method == 'POST':
        member.delete()
        return redirect('conseil_communautaire:admin_list_cities')
    return render(request, 'conseil_communautaire/admin_member_delete.html',
                  {'member': member})
