...
urlpatterns = [
    ...
    path('adminccsa/supprimer-elu/<int:id>/', views.delete_elu,
         name='admin_elu_delete'),
    path('adminccsa/ajouter-document/', views.add_document, name='admin_document_add'),
    path('adminccsa/liste-documents/', views.list_documents,
         name='admin_documents_list'),
    path('adminccsa/modifier-document/<int:id>/', views.update_document,
         name='admin_document_update'),
    path('adminccsa/supprimer-document/<int:id>/', views.delete_document,
