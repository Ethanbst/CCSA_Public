...
from .models import Elus, Document
from .forms import ElusForm, DocumentForm
...
def add_elu(request):
    ...
    if request.method == 'POST':
        ...
        elu_form = ElusForm()
    return render(request, 'bureau_communautaire/admin_elu_add.html',
                  {'elu_form': elu_form})
...
def update_elu(request, id):
    ...
    return render(request, 'bureau_communautaire/admin_elu_update.html',
                  {'elu_form': elu_form})
...
def add_document(request):
    ...
    if request.method == 'POST':
        ...
        if document_form.is_valid():
            ...
            return render(request, 'bureau_communautaire/admin_document_add.html',
...
def list_documents(request):
    ...
    return render(request, 'bureau_communautaire/admin_document_list.html',
                  {'documents': documents})
...
def update_document(request, id):
    ...
    if request.method == 'POST':
        ...
        if document_form.is_valid():
            ...
            # print("Formulaire invalide")
            return render(request, 'bureau_communautaire/admin_document_update.html',
                          {'document_form': document_form})
    else:
...
def delete_document(request, id):
    ...
    if request.method == 'POST':
        ...
        document.delete()
        return redirect('bureau-communautaire:admin_documents_list')
    return render(request, 'bureau_communautaire/admin_document_delete.html',
                  {'document': document})
