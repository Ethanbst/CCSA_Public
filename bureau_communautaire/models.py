...
class Elus(models.Model):
    ...
    picture = models.ImageField(upload_to='bureau_commu/elus/',
                                verbose_name="Photo de l'élu",
                                validators=[validate_taille_fichier,
...
class Document(models.Model):
    ...
    document = models.FileField(upload_to='bureau_commu/documents/',
                                validators=[validate_taille_fichier,
                                            FileExtensionValidator(
                                                allowed_extensions=[
                                                    'pdf'])])
    ...
    ], max_length=12, default='organigramme', blank=False, null=False)
