...
class CommissionTestCase(TestCase):
    ...
    def create_document(self, file_name):
        return Document.objects.create(file=SimpleUploadedFile(
            name=file_name,
    ...
    def test_admin_views_add_commission_post(self):
        ...
        Test de la page d'ajout de commission avec des données valides
        """
        response = self.client.post(reverse('commissions:admin_add_commission'), {
    ...
    def test_admin_views_edit_commission_get(self):
        ...
        """
        commission = self.create_commission(title='Test Commission', icon='icon.png')
        response = self.client.get(reverse('commissions:admin_edit_commission', args=[commission.id]))
        # Vérifier que la réponse est un succès (code 200)
        self.assertEqual(response.status_code, 200)
        # Vérifier que le bon template est utilisé
    ...
    def test_admin_views_edit_commission_post(self):
        ...
        """
        commission = self.create_commission(title='Test Commission', icon='icon.png')
        response = self.client.post(reverse('commissions:admin_edit_commission', args=[commission.id]), {
            'title': 'Modified Commission',
            'icon': 'modified_icon.png'
        })
        # Vérifier que la réponse est une redirection (code 302)
        self.assertEqual(response.status_code, 302)
        # Vérifier que la redirection est correcte
    ...
    def test_admin_views_delete_commission(self):
        ...
        """
        commission = self.create_commission(title='Test Commission', icon='icon.png')
        response = self.client.post(reverse('commissions:admin_delete_commission', args=[commission.id]))
        # Vérifier que la réponse est une redirection (code 302)
        self.assertEqual(response.status_code, 302)
        # Vérifier que la redirection est correcte
        self.assertRedirects(response, reverse('commissions:admin_list_commissions'))
    ...
    def test_admin_views_add_document_post(self):
        ...
        Test de la page d'ajout de document avec des données valides
        """
        response = self.client.post(reverse('commissions:upload_commission_doc'), {
        ...
        self.assertTrue(os.path.exists("test_commission_media/commissions/documents/test.pdf"))
    ...
    def test_admin_views_add_document_post_invalid(self):
        ...
        self.assertFalse(os.path.exists("test_commission_media/commissions/documents/test.pdf"))
    ...
    def test_admin_views_edit_document_get(self):
        ...
        response = self.client.get(reverse('commissions:edit_document', args=[document.id]))
        # Vérifier que la réponse est un succès (code 200)
        self.assertEqual(response.status_code, 200)
        # Vérifier que le bon template est utilisé
    ...
    def test_admin_views_edit_document_post(self):
        ...
        """
        document = self.create_document(file_name='test.pdf')
        response = self.client.post(reverse('commissions:edit_document', args=[document.id]), {
            'file': SimpleUploadedFile(
        ...
        self.assertTrue(os.path.exists("test_commission_media/commissions/documents/modified_test.pdf"))
    ...
    def test_admin_views_edit_document_post_invalid(self):
        ...
        self.assertFalse(os.path.exists("test_commission_media/commissions/documents/modified_test.pdf"))
    ...
    def test_admin_views_delete_document_get(self):
        ...
        """
        document = self.create_document(file_name='test.pdf')
        response = self.client.post(reverse('commissions:delete_document', args=[document.id]))
    ...
    def test_admin_views_edit_mandat_get(self):
        ...
        self.assertEqual(response.status_code, 200)
        # Vérifier que le bon template est utilisé
        self.assertTemplateUsed(response, 'commissions/admin_commission_edit_mandat.html')
        # Vérifier que le formulaire est présent
    ...
    def test_admin_views_edit_mandat_post(self):
        ...
        """
        mandat = self.set_mandat(start_year=2023, end_year=2024)
        response = self.client.post(reverse('commissions:edit_mandat', args=[mandat.id]), {
            'start_year': 2025,
            'end_year': 2026
        })
        # Vérifier que la réponse est une redirection (code 302)
