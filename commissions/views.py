...
from .forms import CommissionForm, CommissionDocForm, MandatForm
...
def list_commission(request):
    ...
    return render(request, 'commissions/admin_commissions_list.html',
                  context)
...
def delete_commission(request, commission_id):
    ...
    if request.method == 'POST':
        commission.delete()
        return redirect('commissions:admin_list_commissions')
    return render(request, 'commissions/admin_commission_delete.html',
...
def delete_document(request, document_id):
    ...
    if request.method == 'POST':
        ...
        document.delete()
        return redirect('commissions:admin_list_commissions')
    return render(request, 'commissions/admin_commission_delete_doc.html',
                  {'document': document})
...
def edit_mandat(request, mandat_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and (form.cleaned_data['start_year'] <
                                form.cleaned_data['end_year']):
            form.save()
            return redirect('commissions:admin_list_commissions')
    else:
        form = MandatForm(instance=mandat)
    return render(request, 'commissions/admin_commission_edit_mandat.html',
                  {'form': form})
